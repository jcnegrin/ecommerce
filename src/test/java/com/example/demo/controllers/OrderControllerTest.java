...
import static com.example.demo.Mother.*;
...
public class OrderControllerTest {
    ...
    public void setup(){
        ...
        when(userRepository.findByUsername("negrin")).thenReturn(user);
    ...
    public void verify_submit(){
        ...
        ResponseEntity<UserOrder> response = orderController.submit("negrin");
    ...
    public void verify_getOrdersForUser() {
        ...
        ResponseEntity<List<UserOrder>> response = orderController.getOrdersForUser("negrin");
        assertNotNull(response);
        assertEquals(200, response.getStatusCodeValue());
